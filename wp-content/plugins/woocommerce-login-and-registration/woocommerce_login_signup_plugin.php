				...
				<div class="col">
					...
					<?php $nonce = wp_create_nonce( 'phoe_login_form' ); ?>
						...
						<p class="form-row">
							...
							<input type="submit" class="button" id="login" name="login" value="Đăng nhập">
							<label for="rememberme" class="inline">
								<input name="rememberme" type="checkbox" id="rememberme" value="forever"> Nhớ mật khẩu </label>
						</p>
						<p class="lost_password">
							<a href="<?php echo get_site_url(); ?>/my-account/lost-password/">Quên mật khẩu?</a>
						</p>
					</form>
				</div>
			</div>
					...
					{ 	
						...
						if(is_object($user) && $user->user_email == $reg_email)
						{
							...
							echo'<ul class="woocommerce-error">
									...
									<li><strong>Error:</strong> Tài khoản đã được đăng ký với địa chỉ email của bạn. Vui lòng hãy đăng nhập.</li>
    ...
    function add_header_shortcode()
	{
		...
		{ 
			...
			if(get_option("popup_status") == 'on')
			{
				...
				echo '<p><a href="#" class="header_login" >Đăng nhập</a> / <a href="#" class="header_signup"> Đăng ký</a> ';
							...
							<div class="result1"></div> 
								...
								<?php $nonce_login_pop = wp_create_nonce( 'phoe_login_pop_form' ); ?>
									...
									<p class="form-row">
										...
										<input type="submit" class="button js_login_log" name="login" value="Đăng nhập" id="login1">
										<label for="rememberme" class="inline">
										<input name="rememberme" type="checkbox" id="rememberme" value="forever"> Nhớ mật khẩu </label>
									</p>
								<p class="lost_password">
									<a href="<?php echo get_site_url(); ?>/tai-khoan/lost-password/">Quên mật khẩu?</a>
								</p>
							</form>
						</div>
					</div> 
